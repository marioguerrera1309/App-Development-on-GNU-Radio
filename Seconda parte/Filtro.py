...
class Filtro(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Filtro")
        ...
        # Variables
        ##################################################
        self.S_Signal_1 = S_Signal_1 = 0
        self.S_Signal_0 = S_Signal_0 = 0
        self.variable_qtgui_label_0_0_0_0 = variable_qtgui_label_0_0_0_0 = (S_Signal_1 / 2)
        self.variable_qtgui_label_0_0_0 = variable_qtgui_label_0_0_0 = (S_Signal_0 / 2)
        ...
        self.Signal_1 = blocks.probe_signal_f()
        self.Signal_0 = blocks.probe_signal_f()
        self._variable_qtgui_label_0_0_0_0_tool_bar = Qt.QToolBar(self)

        if None:
            self._variable_qtgui_label_0_0_0_0_formatter = None
        else:
            self._variable_qtgui_label_0_0_0_0_formatter = lambda x: eng_notation.num_to_str(x)

        self._variable_qtgui_label_0_0_0_0_tool_bar.addWidget(Qt.QLabel("Power signal filter: "))
        ...
        self.top_layout.addWidget(self._variable_qtgui_label_0_0_0_0_tool_bar)
        self._variable_qtgui_label_0_0_0_tool_bar = Qt.QToolBar(self)

        if None:
            self._variable_qtgui_label_0_0_0_formatter = None
        else:
            self._variable_qtgui_label_0_0_0_formatter = lambda x: eng_notation.num_to_str(x)

        self._variable_qtgui_label_0_0_0_tool_bar.addWidget(Qt.QLabel("Power signal: "))
        ...
        self.blocks_moving_average_xx_0_0_0 = blocks.moving_average_ff(50000, 0.00002, 4000, 1)
        self.blocks_moving_average_xx_0_0 = blocks.moving_average_ff(50000, 0.00002, 4000, 1)
        self.blocks_complex_to_mag_squared_0_0_0 = blocks.complex_to_mag_squared(1)
        self.blocks_complex_to_mag_squared_0_0 = blocks.complex_to_mag_squared(1)
        self.blocks_add_xx_1 = blocks.add_vcc(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_2_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 500, 0.004, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 500, 0.004, 0, 0)
        self.analog_sig_source_x_1_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 500, 0.004, 0, 3.14159265358979323846264338327950288419716939937510)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 500, 0.004, 0, 3.14159265358979323846264338327950288419716939937510)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_TRI_WAVE, 500, 0.008, 0, 3.14159265358979323846264338327950288419716939937510)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 500, 0.008, 0, 3.14159265358979323846264338327950288419716939937510)
        def _S_Signal_1_probe():
          while True:

            val = self.Signal_1.level()
            try:
              try:
                self.doc.add_next_tick_callback(functools.partial(self.set_S_Signal_1,val))
              except AttributeError:
                self.set_S_Signal_1(val)
            except AttributeError:
              pass
            time.sleep(1.0 / (2))
        _S_Signal_1_thread = threading.Thread(target=_S_Signal_1_probe)
        _S_Signal_1_thread.daemon = True
        _S_Signal_1_thread.start()
        def _S_Signal_0_probe():
          while True:

            val = self.Signal_0.level()
            try:
              try:
                self.doc.add_next_tick_callback(functools.partial(self.set_S_Signal_0,val))
              except AttributeError:
                self.set_S_Signal_0(val)
            except AttributeError:
              pass
            time.sleep(1.0 / (2))
        _S_Signal_0_thread = threading.Thread(target=_S_Signal_0_probe)
        _S_Signal_0_thread.daemon = True
        _S_Signal_0_thread.start()
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_sub_xx_1, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_add_xx_1, 1))
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.analog_sig_source_x_2_0, 0), (self.blocks_add_xx_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_sub_xx_1, 1))
        ...
        self.connect((self.blocks_moving_average_xx_0_0, 0), (self.Signal_0, 0))
        self.connect((self.blocks_moving_average_xx_0_0_0, 0), (self.Signal_1, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_throttle_0_1_0, 0))
        self.connect((self.blocks_sub_xx_1, 0), (self.blocks_throttle_0_1_0_0, 0))
        self.connect((self.blocks_throttle_0_1_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_throttle_0_1_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle_0_1_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_throttle_0_1_0_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        self.connect((self.blocks_throttle_0_1_0_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_0_0_1, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_0_0_1, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_complex_to_mag_squared_0_0_0, 0))
    ...
    def get_S_Signal_1(self):
        return self.S_Signal_1

    def set_S_Signal_1(self, S_Signal_1):
        self.S_Signal_1 = S_Signal_1
        self.set_variable_qtgui_label_0_0_0_0((self.S_Signal_1 / 2))

    def get_S_Signal_0(self):
        return self.S_Signal_0

    def set_S_Signal_0(self, S_Signal_0):
        self.S_Signal_0 = S_Signal_0
        self.set_variable_qtgui_label_0_0_0((self.S_Signal_0 / 2))
    ...
    def set_variable_qtgui_label_0_0_0_0(self, variable_qtgui_label_0_0_0_0):
        ...
        Qt.QMetaObject.invokeMethod(self._variable_qtgui_label_0_0_0_0_label, "setText", Qt.Q_ARG("QString", str(self._variable_qtgui_label_0_0_0_0_formatter(self.variable_qtgui_label_0_0_0_0))))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 600, 1, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 600, 1, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Filtro, options=None):
