...
class TriangolareSpezzato68(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TriangolareSpezzato68")
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 500, 0.004, 0, 4.71238898)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 500, 0.004, 0, 4.71238898)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_TRI_WAVE, 500, 0.004, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 500, 0.004, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.blocks_throttle_0_1_0_0, 0))
...
def main(top_block_cls=TriangolareSpezzato68, options=None):
